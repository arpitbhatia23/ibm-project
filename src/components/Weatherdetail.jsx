...
const Weatherdetail = () => {
  ...
  return (
    ...
    <div className={`grid grid-cols-3 h-auto min-w-3xl max-w-6xl gap-x-16 gap-y-6  px-6 py-6 justify-items-center rounded-xl   font-bold`}>
        <div className={`${theme==="light"?"bg-black text-white":"bg-white text-black"} rounded-none md:rounded-lg min-w-full h-auto flex-col  px-4 py-6  items-center justify-center font-semibold `}>
        ...
        <div className={`${theme==="light"?"bg-black text-white":"bg-white text-black"} rounded-none md:rounded-lg min-w-full h-auto px-4 py-6 flex-col items-center justify-center font-semibold  `}>
        ...
        <div className={`${theme==="light"?"bg-black text-white":"bg-white text-black"} rounded-none md:rounded-lg px-4 py-6 min-w-full h-auto  flex-col items-center justify-center font-semibold `}>
        ...
        <div className={`${theme==="light"?"bg-black text-white":"bg-white text-black"} px-6 py-6 rounded-none md:rounded-lg min-w-full h-auto  flex-col items-center justify-center font-semibold `}>
